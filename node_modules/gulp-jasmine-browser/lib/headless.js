...
function createServer(options) {
  ...
  var opts = (0, _objectWithoutProperties3.default)(options, ['driver', 'random', 'throwFailures', 'spec', 'seed', 'reporter', 'profile', 'onConsoleMessage']);
  ...
  var stream = lazypipe().pipe(function () {
    ...
    return toReporter(reporter || defaultReporters(opts, profile), { onError: onError, onConsoleMessage: onConsoleMessage });
  });
  return stream();
}
